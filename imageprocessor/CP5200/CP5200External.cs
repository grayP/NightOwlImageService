    ...
    public class Cp5200External
    {
      ...
      //  [DllImport(DllPath, CallingConvention = CallingConvention.StdCall)]
       // public static extern int CP5200_Playbill_AddFile(IntPtr hObj, [MarshalAs(UnmanagedType.LPStr)] string pFilename);
        ...
        [DllImport(DllPath, CharSet = CharSet.Auto)]
        public static extern int CP5200_Net_TestController(int nCardID);
        [DllImport(DllPath, CharSet = CharSet.Auto)]
        public static extern int CP5200_Net_TestCommunication(int nCardID);

        [DllImport(DllPath, CharSet = CharSet.Auto)]
        public static extern int CP5200_Net_RestartSys(int ncardId);
